...
Results were gathered by comparing pre- and post-treatment Autism Spectrum Quotient (AQ) scores across participants using statistical tests, including paired t-tests, between groun t-tests, and z-tests, alongside descriptive statistics and 95% confidence intervals to quantify change over the 12-week period. This approach assessed whether observed changes in AQ scores were statistically significant and unlikely to have occurred by chance
