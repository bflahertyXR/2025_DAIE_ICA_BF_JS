...
\textbf{Paired t-test results} Undertaken to analyse changes in AQ
scores pre and post-treatment in each group Question: Is there a
different in each group pre and post treatment?
...
\item
  Alternative hypothesis - Significant difference (pre and
  post-treatment)
\end{itemize}

CBT - significant improvement: t=22.9, p\textless.001. Mean diff =
10.99. CI between 9.2-11 VR - Very big improvement: t=37.6,
p\textless.001. Mean diff = 18.62. CI between 17.6-19.6 CONTROL - no
significant change: t=1.59, p=0.115. Mean diff = 0.6. CI include 0 - no
change

Results suggest that both CBT and VR reduced AQ scores with VR Therapy
having a significant impact

\textbf{Between group t-test results} Undertaken to analyse if there are
significant differences between AQ score between CBT and VR Therapy
group Questions: - Is VR Therapy better than no treatment (VR vs
CONTROL)? - Is CBT better than no treatment (CBT vs CONTROL)? - Is VR
Therapy more effective than CBT (VR vs CBT)?
...
VR vs CONTROL - VR improves more than control: t=-28.95, p\textless.001.
Mean improvement: VR = 18.62, Control = 0.6. CI between -19.25, -16.79.
18 point improvement 18.62 - 0.6 - Significant improvement

CBT vs CONTROL - CBT improves more than control: t=16.35,
p\textless.001. Mean improvement: CBT = 10.09, Control = 0.6. CI between
8.35, 10.63. 9/10 point improvement 10.09 - 0.6 - Significant
improvement

VR vs CBT - CBT improves more than control: t=-12.38, p\textless.001.
Mean improvement: VR = 18.62, CBT = 10.09. CI between -9.84, -7.22. 7-10
point improvement 18.62 - 10.09

Results suggest that both CBT and VR were a significant improvement on
the Control group and comparing VR and CBT showed that the VR group
...
Evaluate whether there is a significant improvement in AQ scores across
all participants, across all groups and determine whether the overall
mean change in AQ scores differed significantly from 0
...
\item
  Alternative hypothesis - The mean change in AQ scores does not equals
  0
\end{itemize}

The average change in AQ scores across all participants showed a
positive value (9.77) meaning that scores decreased after treatment and
that participants improved

The Z score of 19.72 shows that the well above 0 and indicates that
improvement is highly unlikely random and shows the strength of the
evidence

P value is 0, so can reject null hypothesis

95\% Confidence Interval of lower as 8.8 and upper limits at 10.74 shows
that the true average improvement and the narrow confidence interval
shows consistent treatment effect across the sample
